...
module.exports.WG_BIN = process.env.WG_BIN || 'awg';
module.exports.WG_QUICK_BIN = process.env.WG_QUICK_BIN || 'awg-quick';
...
module.exports.WG_ENABLE_ONE_TIME_LINKS = 'false';
